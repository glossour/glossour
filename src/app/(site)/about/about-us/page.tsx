        ...
        <div>
            <div className="container xl:px-40 lg:px-10 md:px-8 px-4 py-40  ">
                <div ref={ref} className="text-center ">
                    ...
                    <Reveal width='100%'>  <h1 className="md:text-4xl lg:text-5xl text-3xl xl:text-6xl font-extrabold  text-red-200 leading-[48px] lg:leading-[72.8px] mb-2 mt-2">OUR COMMITMENT</h1></Reveal>
                ...
                <Reveal width='100%'>  <video src="https://firebasestorage.googleapis.com/v0/b/glossour-43a64.appspot.com/o/WhatsApp%20Video%202024-07-28%20at%2019.54.45_df13f663%20(1)%20(1)%20(1).mp4?alt=media&token=9a3b544b-56bc-42ce-966c-219fd5f1d8dc" autoPlay muted loop className='w-full  rounded-3xl  mt-10' /></Reveal>
                <div className="grid my-20 grid-cols-1 lg:grid-cols-2 gap-10">
                    <Reveal width='100%'>  <motion.div >
                        <h2 className="text-4xl font-bold text-red-200 mb-4">Our Mission</h2>
                    ...
                    <Reveal width='100%'>  <motion.div >
                        <h2 className="text-4xl font-bold text-red-200 mb-4">Our Vision</h2>
                ...
                <div ref={ref} className="mt-20 ">
                    <h2 className="xl:text-5xl lg:text-4xl text-3xl font-bold text-red-200 mb-10 text-center">Our Values</h2>
                    <motion.div
                    ...
                    >
                        <motion.div whileHover={{ translateY: -10 }} transition={{ duration: 0.3 }} className="space-y-5 p-6 flex flex-col justify-center items-center border-2 rounded-3xl bg-white" variants={cardVariants}>
                            <h3 className="text-3xl font-semibold  text-red-200 mb-2">Innovation</h3>
                        ...
                        <motion.div whileHover={{ translateY: -10 }} transition={{ duration: 0.3 }} className="space-y-5 p-6 flex flex-col justify-center items-center border-2 rounded-3xl bg-white" variants={cardVariants}>
                            <h3 className="text-3xl font-semibold text-red-200 mb-2">Integrity</h3>
                            <p className="text-lg leading-relaxed text-center text-black">
                        ...
                        <motion.div whileHover={{ translateY: -10 }} transition={{ duration: 0.3 }} className="space-y-5 p-6 flex flex-col justify-center items-center border-2 rounded-3xl bg-white" variants={cardVariants}>
                            <h3 className="text-3xl font-semibold text-red-200 mb-2">Excellence</h3>
                            <p className="text-lg leading-relaxed text-center text-black">
                        ...
                        <motion.div whileHover={{ translateY: -10 }} transition={{ duration: 0.3 }} className="space-y-5 p-6 flex flex-col justify-center items-center border-2 rounded-3xl bg-white" variants={cardVariants}>
                            <h3 className="text-3xl font-semibold text-red-200 mb-2">Collaboration</h3>
                            <p className="text-lg leading-relaxed text-center text-black">
                        ...
                        <motion.div whileHover={{ translateY: -10 }} transition={{ duration: 0.3 }} className="space-y-5 p-6 flex flex-col justify-center items-center border-2 rounded-3xl bg-white" variants={cardVariants}>
                            <h3 className="text-3xl font-semibold text-red-200 mb-2">Customer Focus</h3>
                            <p className="text-lg leading-relaxed text-center text-black">
                        ...
                        <motion.div whileHover={{ translateY: -10 }} transition={{ duration: 0.3 }} className="space-y-5 p-6 flex flex-col justify-center items-center border-2 rounded-3xl bg-white" variants={cardVariants}>
                            <h3 className="text-3xl font-semibold text-red-200 mb-2">Sustainability</h3>
                            <p className="text-lg leading-relaxed text-center  text-black">
