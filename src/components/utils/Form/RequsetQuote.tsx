        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    className="bg-slate-900/20 backdrop-blur scroll-bar  md:p-8 fixed inset-0 z-[1000] w-full h-screen top-0 left-0 grid place-items-center overflow-y-scroll cursor-pointer"
                >
                    <motion.div
