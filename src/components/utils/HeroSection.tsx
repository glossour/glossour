...
export const AuroraHero = () => {
    ...
    return (
        <motion.section
            ...
            className=" w-full  flex justify-center items-center h-[90vh]  xl:px-64 lg:px-20 md:px-8  bg-gray-950 px-4  xl:pt-36 lg:pt-24 md:pt-24 pt-28 xl:pb-12 lg:pb-12 md:pb-12 pb-12  xl:space-x-15 text-gray-200">
            <video
                autoPlay
                loop
                muted
                className="absolute top-0 left-0 w-full    object-cover  h-[90vh] z-0"
            >
                <source src="/hero.mp4" type="video/mp4" />

            </video>
            <div className="absolute inset-0 h-[90vh] bg-black opacity-50 z-1"></div> {/* Overlay */}
