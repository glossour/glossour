...
const Section6: React.FC<Section> = ({ heading, subheading, paragraph, btn, img, bgImg }) => {
    ...
    return (
        <div ref={ref} className="w-full xl:px-32 lg:px-10 px-4 md:px-8 bg-tertiary-200">
                ...
                >
                    <motion.div variants={contentVariants} className="lg:w-2/3 w-full">
                        <div className="lg:flex flex-col ">
                            ...
                            <motion.p variants={textVariants} className="text-white md:text-2xl text-xl font-bold md:leading-9 f-f-Lato mb-3 md:mb-6">
                                {subheading}
                            </motion.p>
                        </div>
